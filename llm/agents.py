...
# Pay_Agent("Send 8 eth to milan")
def SearchAgent(query:str):
    ...
    final_prompt = ChatPromptTemplate.from_messages(
        [
            ("system", '''You are an AI assistant helping users with answering their query. User will ask a question and you have to answer their query
...
SearchAgent("correct  price of bitcoin")
